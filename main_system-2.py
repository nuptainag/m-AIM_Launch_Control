...
WIRING:
  ...
  - Igniter circuit   : GPIO 27 (BCM) → MOSFET/relay gate
...
class MainSystem:
    ...
    # ── Igniter config ────────────────────────────────────────────────────────
    LAUNCH_PIN      = 27    # BCM GPIO pin — NOTE: pin 17 is used by anemometer
...
if __name__ == '__main__':
    ...
    print("  • Ignition control  (GPIO 27 → MOSFET/relay → igniter)")
